<?php
  ...
  /* Call self with d=1 to start the download - done from mp3act.js */
  if(isset($_GET['d'])){  
    download($_GET['id']);
    exit;
  }
...
<head>
  <title>
    <? echo $GLOBALS['server_title']; ?> | Download Music
  </title>
...
<div id="wrap">
  ...
  <p class='pad'>
    ...
    <strong>
      <a href="download.php?d=1&id=<?php echo $_GET['id']; ?>" title="Start the Download">Start the Download</a>
    </strong>
  </p>
</div>
<br/>
