<?php
/*************************************************************************
*  GrammaFone Digital Music System
*  A streaming solution for your digital music collection
*  http://www.grammafone.com
*  Copyright (C) 2007 B.B. Sabelli
*  
*  See docs for licensing 
*************************************************************************/
...
<div id="topinfo">
	...
	<strong>GrammaFone music system <?php echo "(based on mp3act v" . getSystemSetting("version") . ")"; ?></strong> <?php if(getSystemSetting("mp3bin") != ""){?>[<a href="#" onclick="switchMode('streaming'); return false;" title="Switch to Streaming Mode">stream</a> | jukebox]<?php } ?>
<?php
	/*<strong>GrammaFone music system v<?php echo getSystemSetting("version"); ?></strong> <?php if(getSystemSetting("mp3bin") != ""){?>[<a href="#" onclick="switchMode('streaming'); return false;" title="Switch to Streaming Mode">stream</a> | <a href="#" onclick="switchMode('jukebox'); return false;" title="Switch to Jukebox Mode">jukebox</a>]<?php } ?>*/
?>
...
<div id="wrap">
	...
	<div id="right">
<iframe src="hidden.php" frameborder=0 width="610" height="200" id="hidden" name="hidden"></iframe>
			<div class="box">
				<div class="head">
