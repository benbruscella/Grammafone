...
<div id="topinfo">
	...
	<strong>mp3act music box v1.1</strong>
</div>
<div id="wrap">
	<div id="header">
		...
		case 1:
			if(mp3act_connect()){
				...
				if(@mysql_num_rows($result) > 0){
					...
					echo "<a href=\"http://$GLOBALS[http_server]$GLOBALS[uri_path]/\">Login to your mp3act server</a><br/>";
...
$querys['settingsinfo'] = "INSERT INTO `mp3act_settings` VALUES (NULL,'1.1',0, '', '', 0,0,'','','')";
...
if(!$error){
		...
		case 4:
			mp3act_connect();
			$query = "UPDATE mp3act_settings SET invite_mode=$_POST[invite],sample_mode=$_POST[sample_mode],downloads=$_POST[downloads],amazonid=\"$_POST[amazonid]\",upload_path=\"$_POST[upload_path]\",mp3bin=\"$_POST[mp3bin]\",lamebin=\"$_POST[lamebin]\",phpbin=\"$_POST[phpbin]\" WHERE id=1";
			mysql_query($query);
			...
			echo "<a href=\"http://$GLOBALS[http_server]$GLOBALS[uri_path]/\">Login to your new mp3act server</a><br/>";
			$random_password = substr(md5(uniqid(microtime())), 0, 6);
			$query = "INSERT INTO `mp3act_users` VALUES (NULL, 'admin', 'Admin', 'User', PASSWORD(\"$random_password\"), 10, NOW(), 1, '', 'streaming', 0, 's', '21232f297a57a5a743894a0e4a801fc3', '', '0000-00-00 00:00:00', 1)";
			mysql_query($query);
