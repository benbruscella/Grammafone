...
elseif($_SERVER['argv'][1] == 3){
	echo "play.php playing the playlist\n";
	  ...
	  while(1){
	  	...
	  	$result=mysql_query($newquery);
			echo "play.php got to end of playlist!\n";
			...
			echo "play.php got a file, starting player! ".$row['filename']."\n";
...
elseif($_SERVER['argv'][1] == 4){
	$query1 = "SELECT mp3act_songs.song_id,mp3act_songs.filename FROM mp3act_songs,mp3act_genres WHERE mp3act_songs.genre_id=mp3act_genres.genre_id AND (";
